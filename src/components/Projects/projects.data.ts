...
export const PROJECTS: ProjectItems[] = [
	...
	},
	{
		...
		skills: [
			...
			{
				name: 'ReactQuery',
				icon: '/skill-icons/ReactQuery.svg',
			},
		],
		role: 'Front-end developer',
		completionYear: '2024',
	...
	},
	{
		...
		projectUrl:
			'https://vladislavzaver91.github.io/JS-groups-project-Filmoteka/',
		img: '/projects/filmoteka-main.png',
		skills: [
			{
				name: 'HTML5',
	...
	},
	{
		...
		skills: [
			...
			{
				name: 'Emotion/css',
				icon: '/skill-icons/Emotion.svg',
			},
			{
				name: 'Material UI',
				icon: '/skill-icons/Material-UI.svg',
			},
		],
		role: 'Front-end developer',
		completionYear: '2022',
